...
<body data-sidebar="dark">
    ...
    <div id="layout-wrapper">
        ...
        <?php $page_title = 'Ticket Sub Category ';
        include 'Header.php'; ?>
                                ...
                                <div class="d-flex align-items-end flex-wrap">
                                    <div class="mr-md-3 mr-xl-5">
                                        <div class="d-flex">
                                            ...
                                            <p class="text-primary mb-0 hover-cursor">Ticket Sub Category</p>
                                        </div>
                                    </div>
                                    <br>
                                </div>
                                                       ...
                                                       $sql = "SELECT s.*, c.name as category_name 
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="text-align:right">
                                                                <button data-id="<?= $rows['id']; ?>" name="edit_button" class="btn btn-info btn-sm"><i class="fas fa-edit"></i></button>
                                                                <button data-id="<?= $rows['id']; ?>" name="delete_button" class="btn btn-danger btn-sm"><i class="fas fa-trash"></i></button>
                                                            </td>
                                                        </tr>
                                                    <?php } ?>
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel"><span
                                class="mdi mdi-lan mdi-18px"></span> &nbsp;Crate Sub Cartegory</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                            aria-label="Close"></button>
                    </div>
                    <form action="include/category_server.php?add_subcategory_data=true" method="POST" enctype="multipart/form-data">
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group mb-2">
                                           ...
                                           <select type="text" name="category_id" class="form-select">
                                                ...
                                                <?php
                                                $res = mysqli_query($con, "SELECT * FROM ticket_categories");
        ...
        <div class="modal fade bs-example-modal-lg" tabindex="-1" aria-labelledby="myLargeModalLabel" aria-hidden="true" id="editModal">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form action="include/category_server.php?update_subcategory_data=true" method="POST" enctype="multipart/form-data">
    ...
    <script type="text/javascript">
        ...
        $(document).on('click', "button[name='delete_button']", function() {
            ...
            $('#DeleteConfirm').off('click').on('click', function() {
                $.ajax({
                    url: "include/category_server.php?delete_subcategory_data=true",
                    type: "POST",
                    data: {
                        id: id
                    },

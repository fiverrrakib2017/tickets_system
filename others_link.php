                                ...
                                <div class="d-flex align-items-end flex-wrap">
                                    <div class="mr-md-3 mr-xl-5">
                                        <div class="d-flex">
                                            ...
                                            <p class="text-primary mb-0 hover-cursor">Others Link</p>
                                        </div>
                                    </div>
                                    <br>
                                </div>
                                <div class="d-flex justify-content-between align-items-end flex-wrap">
                                    <button class="btn btn-primary mt-2 mt-xl-0 mdi mdi-account-plus mdi-18px" data-bs-toggle="modal" data-bs-target="#addModal" style="margin-bottom: 12px;">&nbsp;&nbsp;Add New Link</button>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                        <table id="_datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            <thead>
                                                <tr>
                                                    <th>ID</th>
                                                    <th>Link Name</th>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel"><span
                            class="mdi mdi-lan mdi-18px"></span> &nbsp;Others Link</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                        aria-label="Close"></button>
                </div>
                <form action="include/others_link_server.php?add_others_link_data=true" method="POST" enctype="multipart/form-data">
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group mb-2">
                                        ...
                                        <input type="text" name="name" class="form-control" placeholder="Enter Link">
                                    </div>
                                    <div class="form-group mb-2">
    ...
    <div class="modal fade bs-example-modal-lg" tabindex="-1" aria-labelledby="myLargeModalLabel" aria-hidden="true" id="editModal">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel"><span
                            class="mdi mdi-lan mdi-18px"></span> &nbsp;Update Others Link</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                        aria-label="Close"></button>
                </div>
                <form action="include/others_link_server.php?update_others_link_data=true" method="POST" enctype="multipart/form-data">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $(document).on('click', "button[name='edit_button']", function() {
                var id = $(this).data('id');
                $.ajax({
                    url: "include/others_link_server.php?get_others_link_data=true",
                    type: "GET",
                    data: {
                        id: id
                    },
                    ...
                    success: function(response) {
                        if (response.success) {
                            ...
                            $('#editModal input[name="link"]').val(response.data.link);
                        } else {
            ...
            $(document).on('click', "button[name='delete_button']", function() {
                ...
                $('#DeleteConfirm').off('click').on('click', function() {
                    $.ajax({
                        url: "include/others_link_server.php?delete_others_link_data=true",
                        type: "POST",
                        data: {
                            id: id
                        },

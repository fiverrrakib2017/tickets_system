...
<body data-sidebar="dark">
                                ...
                                <div class="d-flex align-items-end flex-wrap">
                                    <div class="mr-md-3 mr-xl-5">
                                        <div class="d-flex">
                                            ...
                                            <p class="text-primary mb-0 hover-cursor">Ticket Assign Members</p>
                                        </div>
                                    </div>
                                    <br>
                                </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                        <table id="ticket_assign_datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            <thead>
                                                <tr>
                                                    <th>ID</th>
                                                    <th>Assign List</th>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel"><span
                            class="mdi mdi-lan mdi-18px"></span> &nbsp;Ticket Assign</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                        aria-label="Close"></button>
                </div>
                <form action="include/tickets_server.php?add_ticket_assign_data=true" method="POST" enctype="multipart/form-data">
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group mb-2">
                                        <label>Ticket Assign Name</label>
                                        <input type="text" name="name" class="form-control" placeholder="Enter Ticket Assign Name">
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <div class="modal fade bs-example-modal-lg" tabindex="-1" aria-labelledby="myLargeModalLabel" aria-hidden="true" id="editModal">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel"><span
                            class="mdi mdi-lan mdi-18px"></span> &nbsp;Update Ticket Assign</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                        aria-label="Close"></button>
                </div>
                <form action="include/tickets_server.php?update_ticket_assign_data=true" method="POST" enctype="multipart/form-data">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#ticket_assign_datatable').DataTable({
                "order": [
                    [0, "desc"]
                ],
                "columnDefs": [{
            ...
            $(document).on('click', "button[name='edit_button']", function() {
                var id = $(this).data('id');
                $.ajax({
                    url: "include/tickets_server.php?get_ticket_assign_data=true",
                    type: "GET",
                    data: {
                        id: id
                    },
            ...
            $(document).on('click', "button[name='delete_button']", function() {
                ...
                $('#DeleteConfirm').off('click').on('click', function() {
                    $.ajax({
                        url: "include/tickets_server.php?delete_ticket_assign_data=true",
                        type: "POST",
                        data: {
                            id: id
                        },

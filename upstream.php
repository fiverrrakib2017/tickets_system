                                ...
                                <div class="d-flex align-items-end flex-wrap">
                                    <div class="mr-md-3 mr-xl-5">
                                        <div class="d-flex">
                                            ...
                                            <p class="text-primary mb-0 hover-cursor">Upstream</p>
                                        </div>
                                    </div>
                                    <br>
                                </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="table-responsive ">
                                       <table id="upstream_table" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                <thead>
                                                    <tr>
                                                        <th>ID</th>
                                                        <th>Upstream Name</th>
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel"><span
                                class="mdi mdi-lan mdi-18px"></span> &nbsp;Crate Upstream</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                            aria-label="Close"></button>
                    </div>
                    <form action="include/upstream_server.php?add_upstream_data=true" method="POST" enctype="multipart/form-data">
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit"  class="btn btn-primary">Create Upstream</button>
                        </div>
                    </form>
                </div>
            </div>
        ...
        <div class="modal fade bs-example-modal-lg" tabindex="-1" aria-labelledby="myLargeModalLabel" aria-hidden="true" id="editModal">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel"><span
                                class="mdi mdi-lan mdi-18px"></span> &nbsp;Update Upstream</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                            aria-label="Close"></button>
                    </div>
                    <form action="include/upstream_server.php?update_upstream_data=true" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Cancle</button>
                            <button type="submit"  class="btn btn-primary">Update Upstream</button>
                        </div>
                    </form>
                </div>
            </div>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $(document).on('click', "button[name='edit_button']", function() {
                ...
                $.ajax({
                    url: "include/upstream_server.php?get_upstream_data=true",
                    type: "GET",
                    data: {
                        id: id
                    },
        ...
        $(document).on('click', "button[name='delete_button']", function() {
            ...
            $('#DeleteConfirm').off('click').on('click', function() {
                $.ajax({
                    url: "include/upstream_server.php?delete_upstream_data=true",
                    type: "POST",
                    data: {
                        id: id
                    },

...
$("#customer_add").click(function() {
    ...
    customerAdd(customer_request_id,user_type, fullname, package, username, password, mobile, address, expire_date, area, customer_houseno, pop,con_charge, price, remarks,liablities, nid, status,customer_connection_type,send_message,device_types, device_names, serial_nos, assign_dates, customer_refer_id);

});

    function customerAdd(customer_request_id,user_type, fullname, package, username, password, mobile, address, expire_date, area, customer_houseno, pop,con_charge, price, remarks,liablities, nid, status,customer_connection_type,send_message,device_types, device_names, serial_nos, assign_dates,customer_refer_id) {
                ...
                else if(customer_refer_id.length==0){
                    toastr.error("Customer Reference is require");
                } else {
...
$("#addCustomerModal").on('show.bs.modal', function (event) {
    ...
    if (!$('#customer_refer_id').hasClass("select2-hidden-accessible")) {

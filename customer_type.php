                                ...
                                <div class="d-flex align-items-end flex-wrap">
                                    <div class="mr-md-3 mr-xl-5">
                                        <div class="d-flex">
                                            ...
                                            <p class="text-primary mb-0 hover-cursor">Customer Type</p>
                                        </div>
                                    </div>
                                    <br>
                                </div>
                                    ...
                                    <div class="table-responsive">
                                        <table id="ticket_topic_datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tbody>
                                                ...
                                                <?php
                                                $sql = "SELECT * FROM customer_type ORDER BY id DESC";
                                                ...
                                                ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="customers.php?customer_type=<?php echo $rows['id']; ?>"><?php echo $rows['name']; ?></a>
                                                        </td>
    ...
    <div class="modal fade " tabindex="-1" aria-labelledby="myLargeModalLabel" aria-hidden="true" id="addModal">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="include/customer_server.php?add_customer_type_data=true" method="POST" enctype="multipart/form-data">
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group mb-2">
                                        ...
                                        <input type="text" name="customer_type_name" class="form-control" placeholder="Enter Customer Type">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-primary">Add New Customer Type</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <div class="modal fade bs-example-modal-lg" tabindex="-1" aria-labelledby="myLargeModalLabel" aria-hidden="true" id="editModal">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel"><span
                            class="mdi mdi-lan mdi-18px"></span> &nbsp;Update Customer Type</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                        aria-label="Close"></button>
                </div>
                <form action="include/customer_server.php?update_customer_type_data=true" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Close</button>
                        <button type="submit" class="btn btn-primary">Update Customer Type</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $(document).on('click', "button[name='edit_button']", function() {
                var id = $(this).data('id');
                $.ajax({
                    url: "include/customer_server.php?get_customer_type_data=true",
                    type: "GET",
                    data: {
                        id: id
                    },
                    ...
                    success: function(response) {
                        if (response.success) {
                            ...
                            $('#editModal input[name="customer_type_name"]').val(response.data.name);
                        } else {
            ...
            $(document).on('click', "button[name='delete_button']", function() {
                ...
                $('#DeleteConfirm').off('click').on('click', function() {
                    $.ajax({
                        url: "include/customer_server.php?delete_customer_type_data=true",
                        type: "POST",
                        data: {
                            id: id
                        },

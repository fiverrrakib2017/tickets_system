                        ...
                        <ul class="metismenu list-unstyled" id="side-menu">
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    ...
                                    <li>
                                        <a href="con_request.php">Connection Request 
                                            <?php
                                            if ($row = $con->query("SELECT COUNT(*) AS total FROM customer_request WHERE status = 0")->fetch_assoc()) {
                                                if ((int)$row['total'] > 0) {
                                                    echo '<span class="badge rounded-pill bg-danger float-end">' . $row['total'] . '</span>';
                                                }
                                            }
                                            ?>
                                    ...
                                    <li><a href="day_wise_recharge.php">Day Wise Recharge </a></li>
                                  
                                    <li><a href="pwdmissmatch.php">Password missmatch</a></li>
                                    <li><a href="customer_import.php">Import Customer</a></li>
                                    <li><a href="customer_sync.php">Customer Sync Mikrotik</a></li>
                                    <li><a href="customer_reference.php">Customer Reference</a></li>
                                    <li><a href="customer_onu_list.php">Customer Onu List</a></li>
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    ...
                                    <li><a href="customer_package.php">Customer Packages</a></li>
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    <li><a href="olt_device_list.php">Device List </a></li>
                                    <li><a href="olt_device_create.php">Device Configure </a></li>
                                    <li><a href="onu_device_list.php">Onu List </a></li>
                                </ul>
                            </li>
                            <?php endif; ?>
                           ...
                           <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    ...
                                    <li><a href="customer_in_stock.php"> In Stock</a></li>
                                    <li><a href="customer_out_stock.php"> Out Stock</a></li>
                                    <li><a href="stock_management.php">Balance Stock </a></li>
                                </ul>
                            </li>
                            <?php endif; ?>
                           ...
                           <li>
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    ...
                                    <li><a href="bank_transfer.php">Bank Transfer</a></li>
                                </ul>
                            </li>
                            <?php endif; ?>
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    ...
                                    <li><a href="bill_collection_report.php">Bill Collection Report</a></li>
                                    <li><a href="cash_collection.php">Cash Collection</a></li>
                                    <li><a href="billing_report.php">Billing Report</a></li>
                                    <li><a href="customer_otc_bill.php">OTC Bill</a></li>
                            ...
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    ...
                                    <li><a href="users_log.php">User Logs</a></li>
                                </ul>
                            </li>
                            <?php endif; ?>
                            <?php if (isset($_SESSION['details']['role']) && $_SESSION['details']['role'] == 'Super Admin'): ?> 
                            <li>
                                ...
                                <ul class="sub-menu" aria-expanded="false">
                                    ...
                                    <li><a href="app_setting.php">Application Settings</a></li>

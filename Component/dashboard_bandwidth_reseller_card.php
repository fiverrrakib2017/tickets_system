...
<div class="row">
    ...
    <div class="col-xl-4 col-md-6 mb-3">
        <a href="bandwidth_customer.php?total_ip=true" class="text-decoration-none">
            <div class="card stat-card">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="flex-grow-1">
                            <p class="stat-title text-muted mb-1">Total Bandwidth Customers</p>
                            <h3 class="stat-value text-success mb-0"><?php echo $total_bandwidth_customer; ?></h3>
                            <small class="text-muted">Total registered Bandwidth Customers</small>
                        </div>
    ...
    <div class="col-xl-4 col-md-6 mb-3">
        <a href="bandwidth_customer.php?online_ip=true" class="text-decoration-none">
            <div class="card stat-card">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="flex-grow-1">
                            <p class="stat-title text-muted mb-1">Online Bandwidth Customers</p>
    ...
    <div class="col-xl-4 col-md-6 mb-3">
        <a href="bandwidth_customer.php?offline_ip=true" class="text-decoration-none">
            <div class="card stat-card">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="flex-grow-1">
                            <p class="stat-title text-muted mb-1">Offline Bandwidth Customers</p>
